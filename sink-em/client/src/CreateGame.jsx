...
function CreateGame({ token, ws, setDisplay }) {
    ...
    const makeGame = async () => {
        const res = await fetch("http://localhost:8080/matching/create", {
            method: "GET",
            headers: {
            ...
            <div className="card-empty w-full max-w-lg mx-auto">
                <div className="grid gap-3">
                    {isCodeAvail ? (
                        ...
                        <h2 className="h2"> Code not available: {userMessage} </h2>
                      ) }
